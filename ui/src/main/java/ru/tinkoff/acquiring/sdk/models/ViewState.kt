...
internal class BrowseFpsBankScreenState(val paymentId: Long, val deepLink: String) : Screen()
internal class FpsBankFormShowedScreenState(val paymentId: Long) : Screen()
